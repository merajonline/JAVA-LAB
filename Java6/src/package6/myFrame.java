		...
		jb3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					{
						stmt = (Statement) conn.createStatement();
						String query3="SELECT * FROM Representative WHERE Repno IN (SELECT RNo FROM Customer WHERE cr > 15000 )";
						//String query3="SELECT * FROM Representative,Customer WHERE Customer.Rno=Representative.Repno";
